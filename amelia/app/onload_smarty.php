...
if(\core\RoleUtils::inRole('user')) \core\App::getSmarty()->assign('l',1);
\core\App::getSmarty()->assign('autologin',\core\ParamUtils::getFromCookies('SWHelper'));
\core\App::getSmarty()->assign('user',\core\SessionUtils::loadObject('user',TRUE));
