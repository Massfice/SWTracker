<?php
	...
	require_once ROOT.'libs/Interfaces/DBManager.interface.php';
	...
	require_once ROOT.'libs/Usage/SettlementManager.class.php';
	require_once ROOT.'libs/Modify/AuthorManager.class.php';
	require_once ROOT.'libs/Modify/PositionManager.class.php';
